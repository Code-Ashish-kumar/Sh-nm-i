  ...
  const tiles = [
    {
      ...
      accent: '#E8553D', // tomato
      icon: (
        <svg className="w-6 h-6" stroke="#E8553D" fill="none" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      accent: '#8FAE7D', // sage
      icon: (
        <svg className="w-6 h-6" stroke="#8FAE7D" fill="none" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      accent: '#D9A441', // marigold
      icon: (
        <svg className="w-6 h-6" stroke="#D9A441" fill="none" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      accent: '#6FA3A0', // muted teal
      icon: (
        <svg className="w-6 h-6" stroke="#6FA3A0" fill="none" viewBox="0 0 24 24">
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
      {tiles.map((tile, index) => (
        <div
          key={index}
          className="group relative overflow-hidden bg-[#1F1A16] border border-[#2A241E] rounded-md p-6 transition-all duration-300 hover:-translate-y-1"
          ...
          onMouseLeave={(e) => {
            e.currentTarget.style.borderColor = '#2A241E';
        ...
        >
          ...
          <div className="relative flex items-start justify-between">
            {/* Left Content */}
            <div>
              <p className="text-[11px] uppercase tracking-[0.12em] font-medium text-[#A89F94]">
                {tile.title}
              </p>

              <h3
                className="mt-3 text-3xl font-semibold tabular-nums text-[#F2EAE0] tracking-tight"
                style={monoFont}
              >
                {tile.value}
              </h3>
